...
const Symposium = () => {
  ...
  return (
    <>
      ...
      <img
        className="aml-bg-1 L1"
        src="./Images/AML-BG-1.png"
        alt=""
        style={{ zIndex: 3 }}
      />
      <img
        className="aml-bg-2 L1"
        src="./Images/AML-BG-2.png"
        alt=""
        style={{ zIndex: 3 }}
      />
      ...
      <img
        className="aml-bg-8 L2"
        src="./Images/AML-BG-6.png"
        alt=""
        style={{ zIndex: 4 }}
      />
      <img className="aml-bg-6" src="./Images/AML-BG-5.png" alt="" />
      <img
        className="aml-bg-7 L2"
        src="./Images/AML-BG-6.png"
        alt=""
        style={{ zIndex: 4 }}
      />
      <section className="nav-home">{/* <span>Symposium...</span> */}</section>
      {/* <Main /> */}
      <Speakers />
    </>
  );
